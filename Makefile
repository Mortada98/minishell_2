...
SRC = src/main.c	src/Handle_command.c	src/Handle_token.c	src/Helper.c  src/prompt.c	src/print.c	src/tools.c	src/meta_char.c	src/utils.c	src/excute.c  src/parse_herdoc.c	\
	src/garbage_collector.c src/manual_realloc.c	src/open_redirection.c	src/set_global_value.c	src/exit_command.c	src/dup_parent_and_child.c	src/lexer.c  src/enviroment.c src/cd.c
