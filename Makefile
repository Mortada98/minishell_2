...
SRC = src/main.c	src/Handle_command.c	src/Handle_token.c	src/Helper.c  src/prompt.c	src/print.c	src/tools.c	src/meta_char.c	src/utils.c	src/excute.c  src/parse_herdoc.c	src/garbage_collector.c
